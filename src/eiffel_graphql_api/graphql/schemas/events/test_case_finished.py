...
class TestCaseFinished(EiffelObjectType):
    """Test case finished object type."""
...
class TestCaseFinishedConnection(graphene.Connection):
    """Test case finished connection."""

    class Meta:
        """Graphene meta data."""

        node = TestCaseFinished
