...
class TestCaseTriggered(EiffelObjectType):
    """Test case triggered object type."""
...
class TestCaseTriggeredConnection(graphene.Connection):
    """Test case triggered connection."""

    class Meta:
        """Graphene meta data."""

        node = TestCaseTriggered
