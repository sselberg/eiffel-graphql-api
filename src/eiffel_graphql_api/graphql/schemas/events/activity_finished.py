...
class ActivityFinished(EiffelObjectType):
    """Eiffel activity finished object type."""
...
class ActivityFinishedConnection(graphene.Connection):
    """Activity finished connection."""

    class Meta:
        """Graphene meta data."""

        node = ActivityFinished
