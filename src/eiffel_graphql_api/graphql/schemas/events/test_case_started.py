...
class TestCaseStarted(EiffelObjectType):
    """Test case started object type."""
...
class TestCaseStartedConnection(graphene.Connection):
    """Test case started connection."""

    class Meta:
        """Graphene meta data."""

        node = TestCaseStarted
