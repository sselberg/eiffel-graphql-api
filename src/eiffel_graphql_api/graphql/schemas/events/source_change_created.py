...
class SourceChangeCreated(EiffelObjectType):
    """Source change created object type."""
...
class SourceChangeCreatedConnection(graphene.Connection):
    """Source change created connection."""

    class Meta:
        """Graphene meta data."""

        node = SourceChangeCreated
